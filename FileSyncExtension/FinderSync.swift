...
//  FileSyncExtension
//
//  Created by staff008 on 2018/07/05.
//  Copyright © 2018年 staff008. All rights reserved.
//
...
class FinderSync: FIFinderSync {
    ...
    override func menu(for menuKind: FIMenuKind) -> NSMenu {
        ...
        menu.addItem(withTitle: CONTEXT_MENU_LIST["GIT_PULL"]!["TITLE"]!, action: #selector(sampleAction(_:)), keyEquivalent: "")
        return menu
    }
    ...
    @IBAction func sampleAction(_ sender: AnyObject?) {
        ...
        if ((item.target as! NSString) as String == CONTEXT_MENU_LIST["GIT_PULL"]!["TITLE"]!) {
